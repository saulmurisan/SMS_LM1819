...
<body>
    <div class="container">
        <?php
            ...
            $registros = mysqli_query($conexion, "SELECT prod.idProductos, prod.descripcion, prod.cantidad, prod.precio, prod.idProveedor, SUM(prod.precio) as preciototal, SUM(prod.cantidad) as cantidadtotal, prov.nombre from productos as prod inner join proveedores as prov on prod.idProveedor = prov.idProveedor") or die("Problemas en la consulta:".mysqli_error($conexion));
