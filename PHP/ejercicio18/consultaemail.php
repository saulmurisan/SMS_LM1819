...
<body>
    <div class="container">
        <?php
            ...
            $registros = mysqli_query($conexion, "SELECT idAlumno, nombre, mail, codigocurso from alumnos WHERE mail LIKE '$email'") or die("Problemas en la consulta:".mysqli_error($conexion));
                ...
                if ($reg = mysqli_fetch_array($registros)) {
                    ...
                    echo "El email indicado no existe en la base de datos";
                }
