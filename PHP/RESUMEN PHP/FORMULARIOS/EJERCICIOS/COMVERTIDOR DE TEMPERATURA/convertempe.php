...
//Realice un formulario para solicitar una temperatura y un desplegable que indique que tipo de 
//temperatura es, con las opciones “Celsius” o “Fahrenheit”. Al pulsar el botón convertir convertirá 
//la temperatura en la otra unidad. Deben ser valores decimales, no puede ser inferior a 
//-273,15 ºC o -459,67 ºF. Para obtener el resultado despejar la siguiente fórmula “F - 32 = 1,8 * C”. 
...
if (empty($tempe)) {
    ...
    if ($unidad == "c") {
//ROUND: Para rendondear en este caso con 2 decilames
